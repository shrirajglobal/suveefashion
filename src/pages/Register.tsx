...
export default function Register() {
  ...
  return (
    <div className="flex items-center justify-center py-12">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-lg px-4">
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Register to access wholesale prices, bulk discounts, and exclusive collections
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <Input value={form.phone} onChange={(e) => update("phone", e.target.value)} maxLength={15} />
                </div>
              </div>
              ...
              <Button type="submit" className="w-full" disabled={loading}>
                {loading ? "Creating account..." : t("cta.register_button")}
              </Button>
            </form>

            <p className="mt-4 text-center text-xs text-muted-foreground">
              After registration, your account will be reviewed and approved within 24-48 hours.
            </p>
